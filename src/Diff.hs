...
data DerivationDiff
  ...
  | DerivationDiff
      ...
      , argumentsDiff   :: Maybe [Patience.Item Argument]
...
diffArgs :: Vector Text -> Vector Text -> Maybe [Patience.Item Argument]
diffArgs leftArgs rightArgs = do
    ...
    then Nothing
        ...
        Just (Patience.diff leftList rightList)
...
diff topLevel leftPath leftOutputs rightPath rightOutputs = do
    ...
    then do
        ...
        then do
            ...
            let inputsDiff = catMaybes mInputsDiff
